...
# command: ../../01_work.rb *.0.bed
	outSuffix = ".1.bed"
	ANN    = "/home/k-hashi/osc-fs/DATA/ANN/hg38_gencode24.bed"
	ANN_EX = "/home/k-hashi/osc-fs/DATA/ANN/hg38_gencode24.EXON.bed"
	ANN_RE = "/home/k-hashi/osc-fs/DATA/ANN/hg38_rmsk.bed" # for others
	namesRNA = [
